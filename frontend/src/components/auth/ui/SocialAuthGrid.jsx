...
export default function SocialAuthGrid({ onSocial }) {
  const providers = [
      ...
      <div className="grid grid-cols-4 gap-2">
        {providers.map((p) => (
          <button
            ...
            className="flex items-center justify-center rounded-xl border border-slate-200 bg-white py-2.5 transition-all hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md dark:border-white/10 dark:bg-white/[0.04] dark:hover:border-white/20"
          >
            <p.icon />
          </button>
        ))}
