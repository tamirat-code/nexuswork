...
export const getTalentApiConsent = (token) => apiRequest("/students/me/talent-api-consent", { token });
export const updateTalentApiConsent = (payload, token) =>
  apiRequest("/students/me/talent-api-consent", { method: "PATCH", body: payload, token });
