    ...
    return (
      <AuthShell eyebrow="Verified" title="Email confirmed">
        <div className="rounded-card border border-escrow bg-escrow-100 p-5 flex gap-3">
          ...
          <p className="text-sm text-ink">Your email is verified. You're all set.</p>
        </div>
        <Link to="/dashboard" className="mt-6 inline-block text-sm font-semibold text-ink hover:underline">
          Go to dashboard
        </Link>
      </AuthShell>
    );
