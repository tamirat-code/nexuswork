    ...
    <div className="mx-auto max-w-4xl animate-fade-up">
      ...
      {items.length === 0 && (
        <Card className="mt-8 p-14 text-center">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Proposal received, milestone funded,
            and dispute updates will land here.
          </p>
        </Card>
      )}
        ...
        {items.map((notification) => {
          ...
          return (
            <button
              ...
              onClick={() =>
                !isRead &&
                markOne.mutate(notification._id)
              }
              className={`w-full cursor-pointer rounded-card border p-4 text-left transition-colors hover:border-brass/40 ${
                isRead
