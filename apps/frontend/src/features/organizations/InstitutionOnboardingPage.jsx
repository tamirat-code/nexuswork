    ...
    <div className="mx-auto w-full max-w-5xl animate-fade-up space-y-6">
      <header className="relative overflow-hidden rounded-card border border-ink-300 bg-ink-900 px-6 py-8 shadow-card sm:px-8">
        ...
        <div className="relative flex max-w-3xl items-start gap-4">
          <div className="hidden rounded-card border border-brass/25 bg-brass/10 p-3 text-brass sm:block"><Building2 className="h-7 w-7" aria-hidden="true" /></div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-brass">Institution onboarding</p>
            <h1 className="mt-2 font-display text-3xl tracking-tight text-slate sm:text-4xl">Bring your institution to NexusWork</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">Submit your institution details and official evidence. Our administrators verify the request before enabling the institution workspace and university services.</p>
          </div>
        </div>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1.45fr)_minmax(280px,0.75fr)]">
        <Card>
          <CardHeader className="border-b border-ink-300">
            <div className="flex items-center gap-3">
              <div className="rounded-control bg-brass/10 p-2 text-brass"><FileCheck2 className="h-5 w-5" aria-hidden="true" /></div>
          ...
          <CardContent className="space-y-5 pt-6">
            ...
            <div className="flex items-start gap-2 text-xs text-slate-300"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-escrow" aria-hidden="true" /><span>This document is private and is only available to administrators reviewing your request.</span></div>
