            ...
            <div className="mt-4 space-y-2 rounded-control border border-ink-300 bg-ink-700 p-3 text-sm text-slate-300">
              ...
              <p className="flex items-center gap-2">
                ...
                {v.document_file_id?.url ? (
                  ...
                  >
                    {t("universities.viewDocument", { defaultValue: "View uploaded document" })} ({displayFilename(v.document_file_id.original_name, t("universities.file", { defaultValue: "file" }))})
                  </button>
                ) : (
