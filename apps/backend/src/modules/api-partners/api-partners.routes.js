...
import {
  createPartnerSchema, createApiKeySchema, updatePartnerStatusSchema, apiPartnerParamsSchema, apiKeyParamsSchema, ownKeyParamsSchema,
...
import {
  create, list, get, keys, createKey, revokeKey, updateStatus, profile, talentSearch,
