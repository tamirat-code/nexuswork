...
import { postEvent, getPlatform, getMine, getUniversity, getMyUniversity, getDelivery } from "./analytics.controller.js";
...
router.get("/delivery", requireAuth, getDelivery);

router.get(
  "/university/mine",
  requireAuth,
  requireRole(ROLES.UNIVERSITY_STAFF),
  getMyUniversity
);
