...
import { createInvoice, createOrganizationInvoice, listInvoicesForUser, getInvoiceById, getInvoiceForDownload, updateInvoiceStatus } from "./invoices.service.js";
...
export const postOrganizationInvoice = asyncHandler(async (req, res) => {
  const invoice = await createOrganizationInvoice({
    organizationId: req.params.organizationId,
    milestoneIds: req.body.milestone_ids,
    requestingUserId: req.user._id,
    dueDate: req.body.due_date,
    auditContext: { actor: req.user, correlationId: req.correlationId },
  });
